...
$total_anuncios = $a->getTotoalAnuncios($filtros);
...
?>
	<div class="container-fluid">
		<div class="jumbotron">
			...
			<p>E mais de <?php echo $total_usuario; ?> usuários cadastrados.</p>
		</div>
		<!-- Grids -->
		<div class="row">
			<div class="col-sm-3">
				...
				<form method="GET">
					...
					<div class="form-group">
						<label for="estado">Estado de Concervação:</label>
						...
						<?php foreach($anuncios as $anuncio): ?>
							<tr>
								<td>
									...
									<?php else: ?>
										<img src="assets/image/default.png" height="50" border="0" />
									<?php endif; ?>
								</td>
								<td>
